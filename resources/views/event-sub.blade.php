            ...
            <div class="firework article-main">
                <div class="article-top">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                           <h1 class="mx-auto pt-5" style="font-weight:900; font-size:48px; width:fit-content;">{{$event->title}}</h1>
                        </div>
                        <div class="col-sm-3">
                ...
                <div class="article-main">
                    <div class="container">
                        <div class="card article-middle-bg-2 p-2">
                            <div class="row article-middle-dashed-1 px-3 py-4">
                                <div class="col-sm-6 d-flex">
                                    <div class="col-sm-7">
                                        <img class="img-lg" src="{{$event->img}}" style="width: 275px;" alt="">
                                        <div class="py-3">
                                ...
                                <div class="col-sm-6 d-flex">
                                    <div class="col-sm-6">
                                        <img class="img-lg" src="{{$event->img1}}" style="width: 235px;" alt="">
                                        <p class="text-dark" style="text-align: justify; padding-right: 1rem;">
                                            {{$event->description}}
                                        </p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="text-dark" style="text-align: justify; padding-left: 1rem;">
                                            {{$event->end_intro}}
                                        </p>
                                        <img class="img-lg" src="{{$event->img2}}" style="width: 235px; float: right;" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
