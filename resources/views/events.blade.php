                                ...
                                @foreach($events as $item)
                                    <div class="col-sm-1 px-3">
                                        <div class="card" style="border-radius: 10px;">
                                            <img src="{{$item->img}}" alt="" style="border-radius: 10px; width:100%; height:147px">
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <a href="/events_detail/{{$item->id}}" class="btn px-0"><img src="/img/xem chi tiết btn.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
